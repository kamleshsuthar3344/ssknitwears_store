...
export default function About() {
    return (
        <Layout>
            <SEO title="About Us | S S Knitwears" description="Learn about S S Knitwears - our heritage, quality craftsmanship, and commitment to sustainable fashion." />
                ...
                <div className="container mx-auto px-6 py-20 space-y-32">
                    ...
                    <section className="bg-brand-cream rounded-[3rem] p-10 md:p-16 border border-gray-200 flex flex-col lg:flex-row gap-12 items-center">
                        ...
                        <div className="lg:w-2/3 order-1 lg:order-2 space-y-8">
                            ...
                            <p className="text-gray-600 leading-relaxed text-lg text-justify">
                                At <strong className="text-gray-900">S S Knitwears</strong>, we design, develop, and deliver high-quality knitwear that blends functionality with contemporary style. From season-ready basics to tailored knitted pieces, we cater to a wide range of needs. Our process begins with thoughtful fabric creation — prioritizing <strong className="text-gray-900">comfort</strong>, <strong className="text-gray-900">durability</strong>, and <strong className="text-gray-900">sustainability</strong> — and continues through meticulous pattern development, precision knitting, and rigorous quality checks. By combining skilled craftsmanship with efficient manufacturing practices, we ensure timely delivery without compromising on finish or performance. Whether it’s everyday essentials or trend-inspired collections, we bring consistency, reliability, and value to every garment we create.
                            </p>
                        </div>
                    </section>
