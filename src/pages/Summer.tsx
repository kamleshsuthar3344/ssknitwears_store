...
export default function Summer() {
    ...
    return (
        <Layout>
            <SEO
                title="Summer Collection | SS Knitwear"
                description="Stay cool and chic with our exclusive summer lightweight collection."
            />
            {/* Hero Section */}
            <div className="pt-24 pb-12 px-4">
                ...
                >
                    ...
                    <div className="relative z-10 w-full px-8 md:px-16 py-12 flex flex-col items-center text-center">
                        ...
                        >
                            Stay cool and chic with our exclusive summer lightweight collection.
                        </motion.p>
                                    ...
                                    <button
                                        ...
                                        onClick={() => {
                                            ...
                                            const targetPath = cat.name === 'All'
                                                ? '/shop?season=Summer'
                                                : `/shop/${targetCategory}?season=Summer`;
                                            navigate(targetPath);
                                        }}
